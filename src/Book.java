public class Book {
    ...
    //public static String book = null; // for printing out a book with maximum pages
    ...
    public static String toPages() { // to show a book with maximum pages
        return maxPages + " pages is maximum that has a book in our library";
    }
}
